	...
	public static void main(String[] args) throws Exception {
		...
		context.addRoutes(new RouteBuilder() {
			...
			public void configure() throws Exception {
				 from("timer://negociacoes?delay=5s").
				 	to("direct:http").
				 	to("direct:soap");
	                ...
	                to("http4://argentumws.caelum.com.br/negociacoes").
	                  ...
	                  unmarshal(new XStreamDataFormat(stream)).
	                  split(body()).
	                  log("${body}").
...
//		          to("file:saida");
	...
	private static MysqlConnectionPoolDataSource criaDataSource() throws SQLException, ClassNotFoundException {
		MysqlConnectionPoolDataSource mysqlDS = new MysqlConnectionPoolDataSource();
		mysqlDS.setDatabaseName("db_negociacoes");
